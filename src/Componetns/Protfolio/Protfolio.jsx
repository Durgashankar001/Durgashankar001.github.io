      ...
      <div className='container portfolio_container'>
        <article className='portfolio_item'>
          ...
          <div className='portfolio_item-cta'>
            <a data-aos="fade-right" data-aos-duration="2000" href="https://github.com/Durgashankar001/resilient-thrill-6327" className='btn' target="_blank">Github</a>
            <a data-aos="fade-right"  href="https://uboricc.netlify.app/" className='btn btn_primary' target="_blank">Live Demo</a>
          </div>
        </article>
        <article className='portfolio_item'>
          <div className="portfolio_item_image">
          ...
          <div className='portfolio_item-cta'>
            <a data-aos="fade-left"  href="https://github.com/Durgashankar001/humble-lock-7647" className='btn' target="_blank">Github</a>
            <a data-aos="fade-left" data-aos-duration="2000"  href="https://moonlit-jelly-60aaa4.netlify.app/" className='btn btn_primary' target="_blank">Live Demo</a>
          </div>
        </article>
        <article className='portfolio_item'>
          <div className="portfolio_item_image">
          ...
          <p className='bold'>Tech stack :  HTML | CSS | Javascript | LocalStorage</p>
          <div className='portfolio_item-cta'>
            <a data-aos="fade-right" data-aos-duration="2000" href="https://github.com/skypassboy/India-mart-clone" className='btn' target="_blank">Github</a>
            <a data-aos="fade-right"  href="https://indiamartcloneteamflex.netlify.app/productservice" className='btn btn_primary' target="_blank">Live Demo</a>
          </div>
        </article>
        {/* <article className='portfolio_item'>
          <div className="portfolio_item_image">
